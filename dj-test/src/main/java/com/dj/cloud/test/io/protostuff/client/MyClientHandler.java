...
import com.dj.cloud.test.io.protostuff.util.MsgUtil;
...
public class MyClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 接收到消息内容：" + new Gson().toJson(msg));
    }
